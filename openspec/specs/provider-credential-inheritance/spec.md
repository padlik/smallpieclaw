# Provider Credential Inheritance Specification

## Purpose

Define how model and embeddings configuration inherits credentials and transport defaults from provider-level configuration.
